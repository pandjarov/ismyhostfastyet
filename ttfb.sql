...
SELECT
  CASE
   ...
   WHEN platform = 'b7440e60b07ee7b8044761568fab26e8' THEN 'SiteGround cPanel'
   WHEN platform = '624d5be7be38418a3e2a818cc8b7029b' THEN 'SiteGround cPanel'
   WHEN platform = '6b7412fb82ca5edfd0917e3957f05d89' THEN 'SiteGround Site Tools'
